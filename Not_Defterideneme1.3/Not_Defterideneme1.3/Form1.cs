...
namespace Not_Defterideneme1._3
{
    ...
    {
        private int TabCount = 0; //o anda açik olan belgeler
        public Form1()
        {
            InitializeComponent();
        }
        ...
        private void RemoveTab(TabControl tabControl1) // Sekmeleri Kaldýrma
        {
        ...
        private void RemoveAllTab() // Tüm sekmeleri kaldýrma
        {
        ...
        private void RemoveAllTabsButThis() //Açýk olan haricinde sekmeleri kapatýr
        {
            foreach (TabPage Page in tabControl1.TabPages)
            {
        ...
        #endregion
        #region KaydetAç
        private void Save() // Belgeyi kaydetme iþlemi
        {
            ...
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    // Dosya uzantýsýna göre format belirle
        ...
        private void SaveAs() // Belgeyi farklý isimle kaydet
        {
            saveFileDialog1.FileName = tabControl1.SelectedTab.Name;
            saveFileDialog1.InitialDirectory = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
            saveFileDialog1.Filter = "RTF|*.rtf|Text Files|*.txt|All Files|*.*";
        ...
        private void Open() // Belgeyi açma iþlemi
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                toolStripStatusLabel1.Text = "Toplam karakter sayýsý = " +
